...
Sistema de CRM (*Customer Relationship Management*) desenvolvido especificamente para gestão de leads educacionais da **Zouza School - Sistemas Escolares**. Mais informações sobre a [Zouza School](https://zouza-school-sistemas.netlify.app/).
